...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Machine.operating_system'
        db.alter_column(u'core_machine', 'operating_system_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.OperatingSystem'], null=True))

    def backwards(self, orm):

        # Changing field 'Machine.operating_system'
        db.alter_column(u'core_machine', 'operating_system_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.OperatingSystem'], unique=True))
