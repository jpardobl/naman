...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Iface.nat'
        db.alter_column(u'core_iface', 'nat', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True))

    def backwards(self, orm):

        # Changing field 'Iface.nat'
        db.alter_column(u'core_iface', 'nat', self.gf('django.db.models.fields.IntegerField')(null=True))
