...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VLan.general_purpose_service'
        db.add_column(u'core_vlan', 'general_purpose_service',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VLan.general_purpose_service'
        db.delete_column(u'core_vlan', 'general_purpose_service')
    ...
    models = {
        ...
        u'core.vlan': {
            ...
            'general_purpose_service': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
