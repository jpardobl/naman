...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rule.terminal'
        db.add_column(u'core_rule', 'terminal',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rule.terminal'
        db.delete_column(u'core_rule', 'terminal')


    models = {
        u'core.conditional': {
            'Meta': {'object_name': 'Conditional'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'statement1': ('django.db.models.fields.CharField', [], {'default': "'environment'", 'max_length': '60'}),
            'statement2': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'core.rule': {
            ...
            'action': ('django.db.models.fields.CharField', [], {'max_length': '65', 'null': 'True', 'blank': 'True'}),
