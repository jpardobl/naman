...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Iface', fields ['ip']
        db.delete_unique(u'core_iface', ['ip'])
        ...
        db.create_table(u'core_service', (
            ...
            ('iface', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Iface'])),
        ))
        db.send_create_signal(u'core', ['Service'])

        # Adding unique constraint on 'Iface', fields ['ip']
        db.create_unique(u'core_iface', ['ip'])
