...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field service_vlans on 'Project'
        m2m_table_name = db.shorten_name(u'core_project_service_vlans')
        ...
        db.create_unique(m2m_table_name, ['project_id', 'vlan_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field service_vlans on 'Project'
        db.delete_table(db.shorten_name(u'core_project_service_vlans'))
