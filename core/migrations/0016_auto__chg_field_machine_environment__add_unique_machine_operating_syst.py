...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Machine', fields ['hostname']
        db.delete_unique(u'core_machine', ['hostname'])


        # Changing field 'Machine.environment'
        db.alter_column(u'core_machine', 'environment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Environment'], null=True))
        # Adding unique constraint on 'Machine', fields ['operating_system']
        db.create_unique(u'core_machine', ['operating_system_id'])


        # Changing field 'Machine.dns_zone'
        db.alter_column(u'core_machine', 'dns_zone_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DNSZone'], null=True))

        # Changing field 'Machine.hostname'
        db.alter_column(u'core_machine', 'hostname', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Machine.role'
        db.alter_column(u'core_machine', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Role'], null=True))

        # Changing field 'Machine.mtype'
        db.alter_column(u'core_machine', 'mtype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.MType'], null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'Machine', fields ['operating_system']
        db.delete_unique(u'core_machine', ['operating_system_id'])


        # Changing field 'Machine.environment'
        db.alter_column(u'core_machine', 'environment_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Environment']))

        # Changing field 'Machine.dns_zone'
        db.alter_column(u'core_machine', 'dns_zone_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.DNSZone']))

        # Changing field 'Machine.hostname'
        db.alter_column(u'core_machine', 'hostname', self.gf('django.db.models.fields.CharField')(default='', max_length=15, unique=True))
        # Adding unique constraint on 'Machine', fields ['hostname']
        db.create_unique(u'core_machine', ['hostname'])


        # Changing field 'Machine.role'
        db.alter_column(u'core_machine', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Role']))

        # Changing field 'Machine.mtype'
        db.alter_column(u'core_machine', 'mtype_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.MType']))
    ...
    models = {
        ...
        u'core.machine': {
            ...
            'operating_system': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.OperatingSystem']", 'unique': 'True', 'blank': 'True'}),
